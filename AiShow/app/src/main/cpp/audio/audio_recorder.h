...
class AudioRecorder {
  ...
  std::function<void(void *ctx, sample_buf *data)> callback_;
  void *callbackCtx_;
  sample_buf *m_bufs_ = nullptr;
 ...
 public:
  ...
  void RegisterCallback(void* ctx,std::function<void(void *ctx, sample_buf *data)> func);
